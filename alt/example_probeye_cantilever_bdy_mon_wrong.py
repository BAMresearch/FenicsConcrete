...
class FwdModel1(ForwardModelBase):
    def interface(self):
        ...
        self.output_sensors = [Sensor("hor_disp_rest", std_model="sigma_model", std_measurement="sigma_x_rest"),
                               Sensor("ver_disp_rest", std_model="sigma_model", std_measurement="sigma_y_rest"),
                               Sensor("hor_disp_clamp", std_model="sigma_model", std_measurement="sigma_x_clamp"),
                               Sensor("ver_disp_clamp", std_model="sigma_model", std_measurement="sigma_y_clamp")]
